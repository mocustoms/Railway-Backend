...
/**
 * Verify deletion of transactional data
 */
...
async function main() {
  try {
    ...
    const tablesToCheck = [
      { table: 'product_transactions', column: 'companyId', label: 'Product Transactions' },
      { table: 'general_ledger', column: 'companyId', label: 'General Ledger' },
      { table: 'product_expiry_dates', column: 'companyId', label: 'Product Expiry Dates' },
      { table: 'product_serial_numbers', column: 'companyId', label: 'Product Serial Numbers' },
      { table: 'price_history', column: 'companyId', label: 'Price History' },
    ];
    ...
    if (allDeleted) {
      ...
      console.log('  ✅ Product Expiry Dates');
      console.log('  ✅ Product Serial Numbers');
